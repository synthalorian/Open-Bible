#!/usr/bin/env python3
"""
Fetch complete WEB (World English Bible) from rest.api.bible.
...
WEB_BIBLE_ID = "9879dbb7cfe39e4d-04"  # WEB Protestant from API list
OUTPUT_FILE = "/home/synth/projects/open-bible/assets/bible_data/web_complete.json"
...
def get_books():
    return api_request(f"/bibles/{WEB_BIBLE_ID}/books")

def get_chapters(book_id):
    return api_request(f"/bibles/{WEB_BIBLE_ID}/books/{book_id}/chapters")

def get_chapter_content(chapter_id):
    return api_request(f"/bibles/{WEB_BIBLE_ID}/chapters/{chapter_id}?content-type=text")
