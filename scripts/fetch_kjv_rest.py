#!/usr/bin/env python3
"""
Fetch complete KJV Bible from rest.api.bible - saves incrementally.
"""
...
def get_chapter_content(chapter_id):
    return api_request(f"/bibles/{KJV_BIBLE_ID}/chapters/{chapter_id}?content-type=text")
...
def main():
    print("Fetching Complete KJV Bible...", flush=True)
