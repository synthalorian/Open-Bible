#!/usr/bin/env python3
"""
Extract multiple Bibles from Sword modules to JSON.
"""
...
BIBLES_TO_EXTRACT = [
    {'path': '/tmp/bbe', 'module': 'BBE', 'id': 'bbe', 'name': 'Bible in Basic English', 'abbr': 'BBE'},
    {'path': '/tmp/drc', 'module': 'DRC', 'id': 'drc', 'name': 'Douay-Rheims Catholic', 'abbr': 'DRA'},
    {'path': '/tmp/leb', 'module': 'LEB', 'id': 'leb', 'name': 'Lexham English Bible', 'abbr': 'LEB'},
    {'path': '/tmp/litv', 'module': 'LITV', 'id': 'litv', 'name': 'Literal Translation', 'abbr': 'LITV'},
]
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"TOTAL VERSES EXTRACTED: {total_verses_all:,}")
    print(f"{'='*60}")
