#!/usr/bin/env python3
"""
Extract additional Bibles from Sword modules.
"""
...
BIBLES_TO_EXTRACT = [
    {'path': '/tmp/gen', 'module': 'Geneva1599', 'id': 'gen', 'name': 'Geneva Bible (1599)', 'abbr': 'GEN'},
    {'path': '/tmp/darby', 'module': 'Darby', 'id': 'darby', 'name': 'Darby Translation', 'abbr': 'DAR'},
    {'path': '/tmp/tyndale', 'module': 'Tyndale', 'id': 'tyndale', 'name': "Tyndale's Bible", 'abbr': 'TYN'},
]
