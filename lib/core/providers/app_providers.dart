...
enum ReadingMode { day, night, sepia, amoled, synthwave, blackshield }
...
class SettingsNotifier extends StateNotifier<AppSettings> {
  ...
  Future<void> _load() async {
    try {
      ...
      final newState = state.copyWith(
        ...
        isDarkMode: modeIndex == ReadingMode.night.index || modeIndex == ReadingMode.amoled.index || modeIndex == ReadingMode.synthwave.index || modeIndex == ReadingMode.blackshield.index,
  ...
  void setReadingMode(ReadingMode mode) { state = state.copyWith(readingMode: mode, isDarkMode: mode == ReadingMode.night || mode == ReadingMode.amoled || mode == ReadingMode.synthwave || mode == ReadingMode.blackshield); _save(); }
